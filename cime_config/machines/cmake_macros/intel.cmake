...
if (NOT DEBUG)
  string(APPEND CFLAGS " -O1 -debug minimal")
endif()
if (DEBUG)
...
string(APPEND FFLAGS " -convert big_endian -assume byterecl -ftz -traceback -assume realloc_lhs -fp-model precise")
if (compile_threaded)
...
if (NOT DEBUG)
  string(APPEND FFLAGS " -O1 -debug minimal")
endif()
